...
Bienvenue sur mon dépôt regroupant l'ensemble de mes certifications obtenues via le programme **IBM SkillsBuild** durant mon cursus à Holberton School France.

L'objectif de ce repository est de centraliser et de valider mes compétences acquises en Cloud, DevOps, Base de données, Gestion de projet et Cybersécurité.

---

## 🏆 Vue d'ensemble des Certifications

Voici la liste complète de mes accomplissements, classés par thématiques technologiques :

| Thématique | Certification / Badge | Date d'obtention | Validation |
| :--- | :--- | :---: | :---: |
| **DevOps / Cloud** | L'essentiel d'Ansible : automatiser en toute simplicité | 19 Jan 2026 | [Certificat](certificates-trimester-3/) |
...
Les certificats et badges sont organisés de manière chronologique par trimestre d'études :

*   **[Trimestre 1](certificates-trimester-1/)** : Fondations professionnelles et initiation Open Source (*Juin à Août 2025*).
*   **[Trimestre 2](certificates-trimester-2/)** : Bases de données, Gestion de projet approfondie, Cloud & Sécurité (*Septembre à Décembre 2025*).
*   **[Trimestre 3](certificates-trimester-3/)** : Spécialisation DevOps & Automation (*Janvier 2026*).

---
*Certifications complétées avec succès par Loïc Le Guen.*